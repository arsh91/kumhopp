...
@section('content')
	...
	<div class="content-wrapper">
		<div class="page-header">
			...
			<p>
				<a href="{{ route('salespersonjobs.index') }}" class="btn btn-primary">Jobs List</a>
			</p>
		</div>
		<div class="card">
			<div class="card-body">
			
				{!! Form::open(['method' => 'POST', 'route' => ['salespersonjobs.store']]) !!}
				...
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<div style="display:none;">
							<input type="hidden" name="job_created_by" value="{{Auth::user()->id}}">
						</div>
